...
class TestCredentials(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_credentials = Credentials('Gmail','lekamcharity','kulangombe')
    ...
    def test_ini_(self):
        ...
        self.assertEqual(self.new_credentials.userName,'lekamcharity')
        self.assertEqual(self.new_credentials.password,'kulangombe') 
